...
void dibujarObjeto() {
  ...
  if (iDistancia < 40) {
    line(pixelesDistancia * cos(radians(iAngulo)), -pixelesDistancia * sin(radians(iAngulo)), (width - width * 0.505) * cos(radians(iAngulo)), -(width - width * 0.505) * sin(radians(iAngulo)));
  }
  popMatrix();
}
...
void dibujarTexto() {
  ...
  text("distancia: " + iDistancia + " cm", width - width * 0.26, height - height * 0.0277);
  textSize(25);
  fill(98, 245, 60);
